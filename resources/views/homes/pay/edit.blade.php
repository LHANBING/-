...
<body>
		<div class="user-address">
									...
									<form class="am-form am-form-horizontal" method="post" action="/home/center/address/">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input type="text" placeholder="收货人必填" id="user-name" name="username" value="{{$address->addressname}}" >
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input type="tel" placeholder="手机号必填" id="user-phone" name="address_tel" value="{{$address->address_tel}}">
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<textarea placeholder="输入详细地址" id="user-intro" rows="3" class="" name="address" style="resize:none;" >{{$address->address}}</textarea>
										...
										<button  class="am-btn am-btn-danger" id="{{$address->id}}"  class="edit">修改</button>
	 		...
	 		$('#user-intro').blur(function(){
			  ...
			  $.post("/home/pay/edit",{id:id,province:province,city:city,area:area,address:address,address_tel:address_tel,addressname:addressname,status:status,"_token":"{{ csrf_token() }}"},function(data){
